...
module.exports = _.assign(presteps, auth, {
    ...
    'search by company name ': function (browser) {
        browser
            .waitForElementVisible('//me-event-presentation-speaker-list//tr[1]/td[3]/input[@type="text"]', 5000)
            .setValue('//me-event-presentation-speaker-list//tr[1]/td[3]/input[@type="text"]', ['Turun Osuuskauppa', browser.Keys.ENTER])
            .useCss()
            .waitForElementVisible('#thisIsMainLoader', 30000)
            .waitForElementNotVisible('#thisIsMainLoader', 30000)
            .useXpath()
            .waitForElementVisible('//tr[1]/td[3]/span[text()="       Turun Osuuskauppa     "]', 10000);
    },
