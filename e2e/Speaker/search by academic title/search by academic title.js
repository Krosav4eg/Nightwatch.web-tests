...
module.exports = _.assign(presteps, auth, {
    ...
    'search by academic title name ': function (browser) {
        browser
            .waitForElementVisible('//me-event-presentation-speaker-list//tr[1]/td[6]/input[@type="text"]', 5000)
            .setValue('//me-event-presentation-speaker-list//tr[1]/td[6]/input[@type="text"]', ['Academic ', browser.Keys.ENTER])
            .useCss()
            .waitForElementVisible('#thisIsMainLoader', 30000)
            .waitForElementNotVisible('#thisIsMainLoader', 30000)
            .useXpath()
            .waitForElementVisible('//tr[1]/td[6]/span[text()="       Academic Title     "]', 10000);
    },
