...
module.exports = _.assign(presteps, auth, {
    ...
    'search by last name ': function (browser) {
        browser
            ...
            .setValue('//me-event-presentation-speaker-list//tr[1]/td[5]/input[@type="text"]', ['Potapoff', browser.Keys.ENTER])
            .useCss()
            .waitForElementVisible('#thisIsMainLoader', 30000)
            .waitForElementNotVisible('#thisIsMainLoader', 30000)
            .useXpath()
            .waitForElementVisible('//tr[1]/td[5]/span[text()="       Potapoff     "]', 10000);
    },
