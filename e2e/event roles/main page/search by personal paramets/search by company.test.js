...
module.exports = _.assign(presteps, auth, {
    ...
    'search by full name of the function title ': function (browser) {
        browser
            ...
            .setValueByXpath('//tr[1]/td[7]/input[@type="text"]', ['RWE Service GmbH', browser.Keys.ENTER])
            .useXpath()
            .waitForElementVisible('//span[contains(text(), "RWE Service GmbH")]', 3000)
    },
    ...
    'search by 1-st letter of the function title ': function (browser) {
        browser
            .useXpath()
            .waitForElementVisible('//h1[text()="Event role"]', 3000)
            .setValueByXpath('//tr[1]/td[7]/input[@type="text"]', ['R', browser.Keys.ENTER])
            .useCss()
    ...
    'search by 3 letter of the function title ': function (browser) {
        browser
            .useXpath()
            .waitForElementVisible('//h1[text()="Event role"]', 3000)
            .setValueByXpath('//tr[1]/td[7]/input[@type="text"]', ['RWE', browser.Keys.ENTER])
            .useCss()
            .waitForElementVisible('#thisIsMainLoader', 3000)
            .waitForElementNotVisible('#thisIsMainLoader', 3000)
            .useXpath()
