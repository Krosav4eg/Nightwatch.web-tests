...
module.exports = _.assign(presteps, auth, {
    ...
    'check awards page info': function (browser) {
        browser
            ...
            .waitForElementVisible('//div[contains(text(),"Contact")]', 7000)
            .waitForElementVisible('//input[@id=1]', 7000)
            .waitForElementVisible('//div[contains(text(),"Company")]', 7000)
            .waitForElementVisible('//input[@id=2]', 7000)
            .waitForElementVisible('//div[contains(text(),"Project"]', 7000)
