...
module.exports = _.assign(presteps, auth, {
    ...
    'add candidate 1': function (browser) {
        browser
            ...
            .waitForElementVisible('//form[@class="form-horizontal award-candidate-form"]//button[@type="submit"]', 10000)
            .click('//form[@class="form-horizontal award-candidate-form"]//button[@type="submit"]')
            .waitForElementVisible('//div[@class="form-group has-error"][1]/div/input', 10000)
            .clearValue('//div[@class="form-group has-success"][1]/div/input')
            .setValue('//div[@class="form-group has-error"][1]/div/input', 'Тестовый проект')
            .waitForElementVisible('//label[text()="Project English name "]', 10000)

            //
            // .waitForElementVisible('//div[@class="form-group has-success"][2]/div/input', 10000)
            // .clearValue('//div[@class="form-group has-success"][2]/div/input')
            // .setValue('//div[@class="form-group has-success"][2]/div/input','Test project')
