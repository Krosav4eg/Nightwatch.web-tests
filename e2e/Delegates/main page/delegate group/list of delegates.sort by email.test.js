...
module.exports = _.assign(presteps, auth, {
    ...
    'sort by email down': function (browser) {
        browser
            ...
            .verify.containsText('//tr[1]/td[6]/span', 'thomas.papperger@unicredit.de')
            .verify.containsText('//tr[2]/td[6]/span', 'thilo.gewaltig@apobank.de')
            .verify.containsText('//tr[3]/td[6]/span', 'sven.staender@seb.de')
            .verify.containsText('//tr[4]/td[6]/span', 'stefan.zeidler@rlp-bank.de')
            .verify.containsText('//tr[5]/td[6]/span', 'Reinhard.Zelger@bhf-bank.com')
    },
});