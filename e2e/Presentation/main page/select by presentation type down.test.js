...
module.exports = _.assign(presteps, auth, {
    ...
    'select by presentation type down': function (browser) {
        browser
            ...
            .verify.elementPresent('//tr[1]/td[4]/span[contains(text(),"Case presentation")]')
            .verify.elementPresent('//tr[2]/td[4]/span[contains(text(),"Case presentation")]')
            .verify.elementPresent('//tr[3]/td[4]/span[contains(text(),"Chairman speach")]')
            .verify.elementPresent('//tr[4]/td[4]/span[contains(text(),"Chairman speach")]')
            .verify.elementPresent('//tr[5]/td[4]/span[contains(text(),"Cross-function keynote")]')
            .verify.elementPresent('//tr[6]/td[4]/span[contains(text(),"Debate")]')
            .verify.elementPresent('//tr[7]/td[4]/span[contains(text(),"Debate")]')
            .verify.elementPresent('//tr[8]/td[4]/span[contains(text(),"Debate")]')
            .verify.elementPresent('//tr[9]/td[4]/span[contains(text(),"Debate")]')
            .verify.elementPresent('//tr[10]/td[4]/span[contains(text(),"FishBowl")]')
            .verify.elementPresent('//tr[11]/td[4]/span[contains(text(),"Group discussion initiation")]')
            .verify.elementPresent('//tr[12]/td[4]/span[contains(text(),"Group discussion initiation")]')
            .verify.elementPresent('//tr[13]/td[4]/span[contains(text(),"Keynote")]')
            .verify.elementPresent('//tr[14]/td[4]/span[contains(text(),"Leadership presentation")]')
            .verify.elementPresent('//tr[15]/td[4]/span[contains(text(),"Leadership presentation")]')
            .verify.elementPresent('//tr[16]/td[4]/span[contains(text(),"Panel discussion")]')
            .verify.elementPresent('//tr[17]/td[4]/span[contains(text(),"Panel discussion")]')
            .verify.elementPresent('//tr[18]/td[4]/span[contains(text(),"Panel discussion")]')
            .verify.elementPresent('//tr[19]/td[4]/span[contains(text(),"Panel discussion")]')
            .verify.elementPresent('//tr[19]/td[4]/span[contains(text(),"Panel discussion")]')
            .verify.elementPresent('//tr[20]/td[4]/span[contains(text(),"Case - whole audience")]');
    },
});