...
module.exports = _.assign(presteps, auth, {
    ...
    'verify numners': function (browser) {
        browser
            .useXpath()
            .verify.elementPresent('//*[text()="Group 1 - orange - 20"]')
            .verify.elementPresent('//*[text()="Group 2 - violet - 19"]')

            .verify.elementPresent('//*[text()="No group - 26 "]')

            .verify.containsText('(//*[@class="panel-body control-label "]/div)[1]', '20')
            .verify.containsText('(//*[@class="panel-body control-label "]/div/p)[2]', '19')
            .verify.containsText('//*[@id="event-delegates-results"]//h4', 'Delegates 0/65');
    },
});
