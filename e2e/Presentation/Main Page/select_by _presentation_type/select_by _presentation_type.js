...
module.exports = _.assign(presteps, auth, {
    ...
    'delegate - Chairman speach . check that number  is correct and the same as in list': function (browser) {
        browser
            ...
            .useXpath()
            .waitForElementVisible('//h4/span[text()="2"]', 5000)
            .waitForElementVisible('//tr[1]/td[4]/span[text()="         Chairman speach       "]', 5000)
            .waitForElementVisible('//tr[2]/td[4]/span[text()="         Chairman speach       "]', 5000);
    ...
    'delegate - Cross-function keynote. check that number  is correct and the same as in list': function (browser) {
        browser
            ...
            .useXpath()
            .waitForElementVisible('//h4/span[text()="1"]', 5000)
            .waitForElementVisible('//tr[1]/td[4]/span[text()="         Cross-function keynote       "]', 5000);
    ...
    'delegate - Debate. check that number  is correct and the same as in list': function (browser) {
        browser
            ...
            .waitForElementVisible('//tr[1]/td[4]/span[text()="         Debate       "]', 5000)
            .waitForElementVisible('//tr[2]/td[4]/span[text()="         Debate       "]', 5000)
            .waitForElementVisible('//tr[3]/td[4]/span[text()="         Debate       "]', 5000)
            .waitForElementVisible('//tr[4]/td[4]/span[text()="         Debate       "]', 5000);
    ...
    ' delegate - FishBowl. check that number  is correct and the same as in list': function (browser) {
        browser
            ...
            .useXpath()
            .waitForElementVisible('//h4/span[text()="1"]', 5000)
            .waitForElementVisible('//tr[1]/td[4]/span[text()="         FishBowl       "]', 5000);
    ...
    ' delegate - Group discussion initiation. check that number  is correct and the same as in list': function (browser) {
        browser
            ...
            .useXpath()
            .waitForElementVisible('//h4/span[text()="2"]', 5000)
            .waitForElementVisible('//tr[1]/td[4]/span[text()="         Group discussion initiation       "]', 5000)
            .waitForElementVisible('//tr[2]/td[4]/span[text()="         Group discussion initiation       "]', 5000);
    ...
    ' delegate - Leadership presentation. check that number  is correct and the same as in list': function (browser) {
        browser
            ...
            .useXpath()
            .waitForElementVisible('//h4/span[text()="2"]', 5000)
            .waitForElementVisible('//tr[1]/td[4]/span[text()="         Leadership presentation       "]', 5000)
            .waitForElementVisible('//tr[2]/td[4]/span[text()="         Leadership presentation       "]', 5000);
    ...
    ' Partner - Keynote. check that number  is correct and the same as in list': function (browser) {
        browser
            ...
            .waitForElementVisible('//tr[3]/td[4]/span[text()="         Keynote       "]', 5000);
