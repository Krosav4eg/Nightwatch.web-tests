...
module.exports = _.assign(presteps, auth, {
    ...
    'choose Show only active': function (browser) {
        browser
            ...
            .verify.containsText('//tr[2]/td[3]/span', 'Khuram')
            .verify.containsText('//tr[3]/td[3]/span', 'Asif')
            .verify.containsText('//tr[4]/td[3]/span', 'Om')
            .verify.containsText('//tr[5]/td[3]/span', 'Mazadul')
    },
