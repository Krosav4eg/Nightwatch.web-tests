...
module.exports = _.assign(presteps, auth, {
    ...
    'check fields/elements that appeared below: Agenda Element Type field': function (browser) {
        browser
            ...
            .clickBySelectorXpath('(//input[@type="checkbox"])[14]')
    ...
    'selected hosts are displayed': function (browser) {
        browser
            ...
            .verify.elementPresent('(//b[contains(text(),"Accenture A/S")])[4]')
            .verify.elementPresent('(//b[contains(text(),"NetApp Denmark ApS")])[2]')
            .verify.elementPresent('(//b[contains(text(),"Accenture A/S")])[5]')

            .setValueByCss('input[ngcontrol="tableSize"]', '5')
