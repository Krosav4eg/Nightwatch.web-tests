...
//             .waitForElementVisible('//modal[@class="modal fade in"]//input[@data-marker="me-modal-attach-presentation-to-element__input__checkbox__3757"]', 3000)
//             .click('//modal[@class="modal fade in"]//input[@data-marker="me-modal-attach-presentation-to-element__input__checkbox__3757"]')
...
//         browser
//             .assert.elementPresent('//modal[@class="modal fade in"]//td[text()="3757"]')
...
//             .pause(3000);
//     },
//     'speaker with id 3756 is displayed': function (browser) {
//         browser
