...
module.exports = _.assign(presteps, auth, {
    ...
    'creation new container for award panel': function (browser) {
        browser
    ...
    'click on add element button  for award panel': function (browser) {
        browser
            .useCss()
    ...
    'element form window is displayed  for award panel': function (browser) {
        browser
            .useXpath()
    ...
    'choose Static agenda element for award panel': function (browser) {
        browser
            .useCss()
    ...
    'blank.click another field  for award panel': function (browser) {
        browser
    ...
    'assertion agenda element type drop down list  for award panel': function (browser) {
        browser
            .useCss()
    ...
    'static agenda element page assertion  for award panel': function (browser) {
        browser
            .useXpath()
    ...
    'blank.click Save  for award panel': function (browser) {
        browser
            .useXpath()
    ...
    'start time can not be before set time for award panel': function (browser) {
        browser
    ...
    'end time can not be after set time for award panel': function (browser) {
        browser
    ...
    'redirection & assertion page for award panel': function (browser) {
        browser
            .pause(2000)
            .useCss()
            .waitForElementNotVisible('#thisIsMainLoader', 10000)
    ...
    'click on edit awards panel for award panel': function (browser) {
        browser
            .pause(1000)
    ...
    'static agenda page displayed and click on background for award panel': function (browser) {
        browser
            .assert.containsText('//label[contains(text(),"           End time ")]', 'End time')
            .assert.containsText('//label[contains(text(),"           Meeting allowed ")]', 'Meeting allowed')
            .assert.containsText('//option[contains(text(),"                 No meetings allowed               ")]', 'No meetings allowed')
    ...
    'click on pencil for award panel': function (browser) {
        browser
            .pause(1000)
            .waitForElementVisible('//a[2]/i[@class="fa fa-pencil edit-element"]', 2000)
            .click('//a[2]/i[@class="fa fa-pencil edit-element"]')
    ...
    'putting check-boxes in Group 1 & Group 2 for award panel': function (browser) {
        browser
            .assert.elementPresent('//div[text()="               Group 1 - orange             "]')
    ...
    'redirection after selection "Group 1 - orange" & "Group 2 - violet"  page  for award panel': function (browser) {
        browser
            .pause(2000)
            .useCss()
            .waitForElementNotVisible('#thisIsMainLoader', 10000)
    ...
    'delete container  for award panel': function (browser) {
        browser
            .useCss()
    ...
    'creation new container for head line': function (browser) {
        browser
            .useCss()
            .waitForElementVisible('button.btn.btn-primary.btn-block', 10000)
            .click('button.btn.btn-primary.btn-block')
    ...
    'click on add element button for head line': function (browser) {
        browser
            .useCss()
            .waitForElementVisible('.btn.btn-info.btn-block', 4000)
            .click('.btn.btn-info.btn-block');
    ...
    'element form window is displayed for head line': function (browser) {
        browser
            .useXpath()
            .assert.elementPresent('//h4[contains(text(),"Element form")]')
            .assert.elementPresent('//label[contains(text(),"           Agenda Element Entry Type ")]');
    ...
    'choose static agenda element for head line': function (browser) {
        browser
            .useCss()
            .waitForElementVisible('select#agendaElementEntryTypeId.form-control', 2000)
            .click('select#agendaElementEntryTypeId.form-control')
    ...
    'blank.click another field for head line': function (browser) {
        browser
            .assert.containsText('//h4[contains(text(),"Element form")]', 'Element form')
            .waitForElementVisible('//label[contains(text(),"Agenda Element Type ")]', 2000)
            .assert.containsText('//label[contains(text(),"Agenda Element Type ")]', 'Agenda Element Type ')
    ...
    'assertion Agenda Element Type drop down list for head line': function (browser) {
        browser
            .useCss()
            .waitForElementVisible('select#agendaElementTypeId', 2000)
            .click('select#agendaElementTypeId')
    ...
    'blank.click Save for head line': function (browser) {
        browser
            .useXpath()
            .click('//option[contains(text(),"               Headline             ")]')
            .pause(1000)
            .useCss()
            .click('select#agendaElementTypeId')
            .useXpath()
    ...
    'static agenda element page assertion for head line': function (browser) {
        browser
            .useXpath()
            .assert.containsText('//label[contains(text(),"           End time ")]', 'End time')
            .assert.containsText('//label[contains(text(),"           Meeting allowed ")]', 'Meeting allowed')
    ...
    'input heading field for head line': function (browser) {
        browser
            .waitForElementVisible('input#heading.form-control.ng-pristine.ng-invalid.ng-touched', 1000)
            .setValue('input#heading.form-control.ng-pristine.ng-invalid.ng-touched', 'autotest2016');
    },

    'input sub heading field for head line': function (browser) {
        browser
            .waitForElementVisible('input#subHeading.form-control.ng-pristine.ng-valid.ng-touched', 1000)
            .setValue('input#subHeading.form-control.ng-pristine.ng-valid.ng-touched', 'test');
    },

    'start time can not be before set time for head line': function (browser) {
        browser
            .waitForElementVisible('me-date-time-input#elementStartHour input.form-control.dateTimeInput.dateTimeInput', 1000)
            .setValue('me-date-time-input#elementStartHour input.form-control.dateTimeInput.dateTimeInput', ['7:59', browser.Keys.ENTER])
            .useXpath()
    ...
    'end time can not be after set time for head line': function (browser) {
        browser
            .waitForElementVisible('me-date-time-input#elementEnd input.form-control.dateTimeInput.dateTimeInput', 1000)
            .setValue('me-date-time-input#elementEnd input.form-control.dateTimeInput.dateTimeInput', ['10:01', browser.Keys.ENTER])
            .useXpath()
    ...
    'redirection & assertion  page for head line': function (browser) {
        browser
            .pause(2000)
            .useCss()
            .waitForElementNotVisible('#thisIsMainLoader', 10000)
    ...
    'click on pencil for head line': function (browser) {
        browser
            .pause(1000)
            .waitForElementVisible('//a[2]/i[@class="fa fa-pencil edit-element"]', 2000)
            .click('//a[2]/i[@class="fa fa-pencil edit-element"]')
    ...
    'putting check-boxes in Group 1 & Group 2 for head line': function (browser) {
        browser
            .assert.elementPresent('//div[text()="               Group 1 - orange             "]')
            .assert.elementPresent('//checkbox-item[@data-marker="me-event-agenda-element-form__input__checkbox__0"]')
            .click('//checkbox-item[@data-marker="me-event-agenda-element-form__input__checkbox__0"]')
    ...
    'redirection after selection "Group 1 - orange" & "Group 2 - violet"  page for head line': function (browser) {
        browser
            .pause(2000)
            .useCss()
            .waitForElementNotVisible('#thisIsMainLoader', 10000)
    ...
    'delete head line panel': function (browser) {
        browser
            .useXpath()
            .waitForElementVisible('//a[3]/i[@class="fa fa-trash-o delete-element"]', 1000)
            .click('//a[3]/i[@class="fa fa-trash-o delete-element"]')
    ...
    'head line has been deleted': function (browser) {
        browser
            .useXpath()
            .assert.elementNotPresent('//h5[contains(text(),"08:00 - 09:45")]')
            .assert.elementNotPresent('//h5[contains(text(),"autotest2016")]')
            .assert.elementNotPresent('//button[contains(text(), "Add room")]');
    },
    'delete container for head line': function (browser) {
        browser
            .useCss()
            .click('.fa.fa-trash-o.delete-container')
            .waitForElementVisible('div.modal-footer>button.btn.btn-success', 4000)
    ...
    'creation new container for presentation-chairman': function (browser) {
        browser
            .useCss()
            .waitForElementVisible('button.btn.btn-primary.btn-block', 10000)
            .click('button.btn.btn-primary.btn-block')
    ...
    'click on add element button for presentation-chairman': function (browser) {
        browser
            .useCss()
            .waitForElementVisible('.btn.btn-info.btn-block', 4000)
            .click('.btn.btn-info.btn-block');
    ...
    'element form window is displayed for presentation-chairman': function (browser) {
        browser
            .useXpath()
            .assert.elementPresent('//h4[contains(text(),"Element form")]')
            .assert.elementPresent('//label[contains(text(),"           Agenda Element Entry Type ")]');
    ...
    'choose static agenda element for presentation-chairman': function (browser) {
        browser
            .useCss()
            .waitForElementVisible('select#agendaElementEntryTypeId.form-control', 2000)
            .click('select#agendaElementEntryTypeId.form-control')
    ...
    'blank click another field for presentation-chairman': function (browser) {
        browser
            .assert.containsText('//h4[contains(text(),"Element form")]', 'Element form')
            .waitForElementVisible('//label[contains(text(),"Agenda Element Type ")]', 2000)
            .assert.containsText('//label[contains(text(),"Agenda Element Type ")]', 'Agenda Element Type ')
    ...
    'blank click save for presentation-chairman': function (browser) {
        browser
            .useXpath()
            .waitForElementVisible('//div/div/div/div/button[contains(text(),"Save")]', 4000)
            .click('//div/div/div/div/button[contains(text(),"Save")]')
    ...
    'start time can not be before set time for presentation-chairman': function (browser) {
        browser
            .waitForElementVisible('me-date-time-input#elementStartHour input.form-control.dateTimeInput.dateTimeInput', 1000)
            .setValue('me-date-time-input#elementStartHour input.form-control.dateTimeInput.dateTimeInput', ['7:59', browser.Keys.ENTER])
            .useXpath()
    ...
    'end time can not be after set time for presentation-chairman': function (browser) {
        browser
            .waitForElementVisible('me-date-time-input#elementEnd input.form-control.dateTimeInput.dateTimeInput', 1000)
            .setValue('me-date-time-input#elementEnd input.form-control.dateTimeInput.dateTimeInput', ['10:01', browser.Keys.ENTER])
            .useXpath()
    ...
    'click on attach button for presentation-chairman': function (browser) {
        browser
            .useXpath()
            .click('//me-event-agenda-element-presentation/div/div[2]/button[text()="Attach"]');
    },

    'add presentation window is displayed for presentation-chairman': function (browser) {
        browser
    ...
    'chosen person is displayed for presentation-chairman': function (browser) {
        browser
    ...
    'presentation-chairman displayed and click on background': function (browser) {
        browser
            .assert.containsText('//label[contains(text(),"           End time ")]', 'End time')
            .assert.containsText('//label[contains(text(),"           Meeting allowed ")]', 'Meeting allowed')
            .assert.containsText('//option[contains(text(),"                 No meetings allowed               ")]', 'No meetings allowed')
    ...
    'click on pencil option for presentation-chairman': function (browser) {
        browser
            .pause(1000)
            .waitForElementVisible('//a[2]/i[@class="fa fa-pencil edit-element"]', 2000)
            .click('//a[2]/i[@class="fa fa-pencil edit-element"]')
    ...
    'delete container for presentation-chairman': function (browser) {
        browser
            .useCss()
            .click('.fa.fa-trash-o.delete-container')
            .pause(1000)
