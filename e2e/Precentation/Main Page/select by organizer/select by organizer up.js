...
module.exports = _.assign(presteps, auth, {
    ...
    'select by organizer down': function (browser) {
        browser
            ...
            .assert.elementPresent('//tr[1]/td[3]/span/span[text()="           Management Events         "]')
            ...
            .assert.elementPresent('//tr[11]/td[3]/span/span[text()="           Management Events         "]')
            .assert.elementPresent('//tr[12]/td[3]/span/span[text()="           Management Events         "]')
