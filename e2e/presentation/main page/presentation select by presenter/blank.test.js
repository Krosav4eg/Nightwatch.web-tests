...
module.exports = _.assign(presteps, auth, {
    ...
    'select by  blank': function (browser) {
        browser
            ...
            .verify.elementPresent('//tr[13]/td[2]/span[contains(text(),"Partner")]')
            .verify.elementPresent('//tr[14]/td[2]/span[contains(text(),"Partner")]')
            .verify.elementPresent('//tr[15]/td[2]/span[contains(text(),"Partner")]')
            .verify.elementPresent('//tr[16]/td[2]/span[contains(text(),"Delegate")]')
            .verify.elementPresent('//tr[17]/td[2]/span[contains(text(),"Delegate")]')
        //.verify.elementPresent('//tr[18]/td[2]/span[text()="         Delegate       "]')
        // .verify.elementPresent('//tr[19]/td[2]/span[text()="         Delegate       "]')
