...
module.exports = _.assign(presteps, auth, {
    ...
    'select by presentation type down': function (browser) {
        browser
            ...
            .assert.elementPresent('//tr[6]/td[4]/span[text()="         Gold spotlight       "]')
            .assert.elementPresent('//tr[7]/td[4]/span[text()="         Gold spotlight       "]')
            .assert.elementPresent('//tr[8]/td[4]/span[text()="         Gold spotlight       "]')
            .assert.elementPresent('//tr[9]/td[4]/span[text()="         Case - parallel       "]')
